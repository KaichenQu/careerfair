          ...
          <div className="cursor-pointer group">
            <Card className="h-full p-6 relative transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <Box className="flex flex-col h-full">
                <PersonIcon className="text-blue-500 mb-4" sx={{ fontSize: 40 }} />
                <Typography
                  variant="h5"
        ...
        <Grid item xs={12} md={4}>
          <div className="cursor-pointer group">
            <Card className="h-full p-6 relative transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <Box className="flex flex-col h-full">
                <AnalyticsIcon className="text-purple-500 mb-4" sx={{ fontSize: 40 }} />
                <Typography
                  variant="h5"
                  className="font-bold text-gray-800 mb-4"
                >
        ...
        <Grid item xs={12} md={4}>
          <div className="cursor-pointer group">
            <Card className="h-full p-6 relative transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <Box className="flex flex-col h-full">
                <SettingsIcon className="text-green-500 mb-4" sx={{ fontSize: 40 }} />
                <Typography
                  variant="h5"
                  className="font-bold text-gray-800 mb-4"
                >
                ...
                <Button
                  ...
                  onClick={() => window.location.href = "/adminPage/careerFair"}
                >
                  Manage System
                </Button>
              </Box>

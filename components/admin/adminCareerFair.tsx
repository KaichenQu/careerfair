...
const AdminCareerFair = () => {
  ...
  const handleDelete = async (fairId: string) => {
    try {
      ...
      setCareerFairs(prevFairs => prevFairs.filter(fair => fair.fair_id !== fairId));
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-500">({fair.fair_id})</span>
                      </div>
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={() => router.push(`/adminPage/careerFair/update/${fair.fair_id}`)}
                      ...
                      <button
                        onClick={() => router.push(`/admin/career-fair/${fair.fair_id}`)}
